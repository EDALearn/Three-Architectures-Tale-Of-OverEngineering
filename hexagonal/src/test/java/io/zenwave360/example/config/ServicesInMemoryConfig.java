...
import io.zenwave360.example.core.outbound.events.*;
...
public class ServicesInMemoryConfig extends RepositoriesInMemoryConfig {
	...
	static List<Customer> _orders;
	public void reloadTestData() {
		var testDataLoader = new TestDataLoader(List.of(Customer.class));

		var orders = _orders != null? _orders : testDataLoader.loadCollectionTestDataAsObjects(Customer.class);
		customerRepository().deleteAll();
		customerRepository().saveAll(orders);
	}
